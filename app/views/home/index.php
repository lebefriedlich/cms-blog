            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    <?php if (isset($data['artikelUtama'])) : ?>
                        <a href="<?= BASEURL; ?>/post/index/<?= $data['artikelUtama']['slug'] ?>"><img class="card-img-top" src="/cms-blog/app/assets/artikel/<?= $data['artikelUtama']['gambar']; ?>" style="height: 500px;" alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted"><?= $data['artikelUtama']['hari_tanggal'] ?></div>
                            <h2 class="card-title"><?= $data['artikelUtama']['judul'] ?></h2>
                            <p class="card-text"><?= $data['potongArtikel'] ?></p>
                ...
                <div class="row">
                    <?php foreach ($data['article'] as $article) : ?>
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                <a href="<?= BASEURL; ?>/post/index/<?= $article['slug'] ?>"><img class="card-img-top" src="/cms-blog/app/assets/artikel/<?= $article['gambar']; ?>" alt="..." style="width: 100%; height: 250px; @media (max-width: 992px) {height: 400px;}" /></a>
                                <div class="card-body">
